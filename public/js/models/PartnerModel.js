 ...
 * @static
 */
PartnerModel.FindByPhotoProperties = function(queryParams, uiFunction, uiExtraParams){
	var ajaxParams = {
		obj : 'partner',
	...
	var callbackFunction = function(data, callbackExtraParams){
			if(data){
				...
				console.error("Unable to parse server response.PartnerModel.FindByPhotoProperties()");
			}
		};
	Ajax.Perform(ajaxParams, callbackFunction, uiExtraParams);
};
