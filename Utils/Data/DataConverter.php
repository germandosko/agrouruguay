...
class DataConverter
{
	...
	public static function FormsToPhp($text, $nl2br=true){
		$text = AbstractModel::$IsUsingUtf8 ? utf8_decode(trim($text)) : trim($text);
		if($nl2br){
			return nl2br(htmlentities($text, ENT_COMPAT, AbstractModel::$Charset, false));
		} else {
			return htmlentities($text, ENT_COMPAT, AbstractModel::$Charset, false);
		}
	}
	...
	public static function PhpToForms($text, $br2nl=true){
		...
		return AbstractModel::$IsUsingUtf8 ? utf8_encode($text) : $text;
	}
}